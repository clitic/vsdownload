...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 389, 508))
        ...
        self.save_page_basic_grid_layout.addWidget(self.save_page_tempdir_btn, 13, 2, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.timeoutLabel, 15, 0, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.save_page_ffmpeg_path_btn, 12, 2, 1, 1)
        self.pre_selectLabel = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.pre_selectLabel.setObjectName("pre_selectLabel")
        self.save_page_basic_grid_layout.addWidget(self.pre_selectLabel, 16, 0, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.proxy_addressLineEdit, 11, 1, 1, 1)
        self.tempdirLineEdit = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        self.tempdirLineEdit.setObjectName("tempdirLineEdit")
        self.save_page_basic_grid_layout.addWidget(self.tempdirLineEdit, 13, 1, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.ffmpeg_pathLineEdit, 12, 1, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.retry_countLabel, 14, 0, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.key_ivLabel, 10, 0, 1, 1)
        self.key_ivLineEdit = QtWidgets.QLineEdit(self.scrollAreaWidgetContents)
        self.key_ivLineEdit.setObjectName("key_ivLineEdit")
        self.save_page_basic_grid_layout.addWidget(self.key_ivLineEdit, 10, 1, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.timeoutSpinBox, 15, 1, 1, 1)
        self.tempdirLabel = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.tempdirLabel.setObjectName("tempdirLabel")
        self.save_page_basic_grid_layout.addWidget(self.tempdirLabel, 13, 0, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.retry_countSpinBox, 14, 1, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.proxy_addressLabel, 11, 0, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.pre_selectSpinBox, 16, 1, 1, 1)
        ...
        self.save_page_basic_grid_layout.addWidget(self.ffmpeg_pathLabel, 12, 0, 1, 1)
        self.decryptLabel = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.decryptLabel.setObjectName("decryptLabel")
        self.save_page_basic_grid_layout.addWidget(self.decryptLabel, 9, 0, 1, 1)
        self.decryptCheckBox = QtWidgets.QCheckBox(self.scrollAreaWidgetContents)
        self.decryptCheckBox.setText("")
        self.decryptCheckBox.setObjectName("decryptCheckBox")
        self.save_page_basic_grid_layout.addWidget(self.decryptCheckBox, 9, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.decryptLabel.setText(_translate("MainWindow", "decrypt"))
