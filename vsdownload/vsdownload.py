...
def save(input: str = typer.Argument(..., help="url|.m3u8|log.json"),
        ...
        baseurl: str = typer.Option(None, "--baseurl", "-b", help="base url or endpoint for all segments", metavar="https://xyz.com/playlist7/", show_default=False),
        ...
        retry_count: int = typer.Option(15, help="retry count for downloading segment"),
